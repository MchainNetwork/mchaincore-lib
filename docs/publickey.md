# Public Key
Represents a MarbellaChain public key and is needed to be able to receive MarbellaChain, as is usually represented as a MarbellaChain [Address](address.md). 

A PublicKey in marbellachaincore is an immutable object and can be instantiated from a [Point](crypto.md), string, [PrivateKey](privatekey.md), Buffer or a [BN](crypto.md).
...
> var compressedPK = marbellachaincore.PublicKey('030589ee559348bd6a7325994f9c8eff12bd'+
...
> var compressedPK2 = new marbellachaincore.PublicKey('02a1633cafcc01ebfb6d78e39f687a1f'+
...
> var uncompressed = marbellachaincore.PublicKey('0479BE667EF9DCBBAC55A06295CE870B07029'+
